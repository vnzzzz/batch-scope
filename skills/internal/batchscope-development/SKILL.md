...
情報ごとの正本と文書の責務は`docs/index.md`と`docs/design/agent-skill.md`を参照し、このSkillへ対応表を複製しない。
変更するファイルを正本とみなして作業を始めず、編集前に変更する事実の正本を特定する。
...
複数packageを跨ぐ保証が変わる場合は、コードコメントだけへ閉じず、該当する正本を更新する。
